...
export const heritageSites: HeritageSite[] = [
  {
    ...
    coordinates: { lat: 27.7042, lng: 85.3076 },
    rating: 4.7,
    visitCount: 850000,
  },
  {
  ...
  },
  {
    ...
    bestTimeToVisit: 'March–May / September–November',
    coordinates: { lat: 27.7102, lng: 85.3486 },
    rating: 4.9,
    visitCount: 980000,
  },
  {
    ...
    openingHours: '6:00 AM – 6:00 PM',
    bestTimeToVisit: 'March–May / September–November',
    coordinates: { lat: 27.7216, lng: 85.3622 },
    rating: 4.8,
    visitCount: 680000,
  },
  {
  ...
  },
  {
    ...
    openingHours: '6:00 AM – 6:00 PM',
    bestTimeToVisit: 'March–May / September–November',
    coordinates: { lat: 27.6833, lng: 85.4333 },
    rating: 4.6,
    visitCount: 320000,
  },
  {
    ...
    bestTimeToVisit: 'March–May / September–November',
    coordinates: { lat: 27.6725, lng: 85.3242 },
    rating: 4.7,
    visitCount: 490000,
  },
  {
    ...
    coordinates: { lat: 27.4689, lng: 83.2756 },
    rating: 4.7,
    visitCount: 1200000,
  },
  {
    ...
    openingHours: '6:00 AM – 6:00 PM',
    bestTimeToVisit: 'October–March',
    coordinates: { lat: 27.5333, lng: 84.3333 },
    rating: 4.8,
    visitCount: 220000,
  },
  {
    ...
    openingHours: '24 hours (permits required)',
    bestTimeToVisit: 'March–May / September–November',
    coordinates: { lat: 27.9167, lng: 86.9167 },
    rating: 4.9,
    visitCount: 80000,
  },
];

export const featuredSites = heritageSites.slice(0, 6);

export const features = [
  {
    title: 'Digital Passport',
    description:
      'Collect digital stamps at every heritage site you visit. Your passport becomes a personal travel journal of your Nepali journey.',
    icon: 'Passport',
  },
  {
    title: 'Curated Discovery',
    description:
      'Explore hand-picked UNESCO sites and hidden gems, each with rich stories, practical tips, and local insights you won\'t find in guidebooks.',
    icon: 'Compass',
  },
  {
    title: 'Local Connections',
    description:
      'Find authentic homestays, family-run eateries, and local guides who share Nepal beyond the tourist trail.',
    icon: 'Users',
  },
  {
    title: 'Smart Itineraries',
    description:
      'Plan your days effortlessly with optimized routes that respect your time and help you experience Nepal at your own pace.',
    icon: 'Map',
  },
  {
    title: 'Cultural Guides',
    description:
      'Learn the etiquette, festivals, and traditions that make each site meaningful — from puja rituals to Newari New Year celebrations.',
    icon: 'BookOpen',
  },
  {
    title: 'Offline Access',
    description:
      'Download site guides and maps before you go. No internet? No problem. Your passport and stamps work offline too.',
    icon: 'Wifi',
  },
];
...
export const howItWorks = [
  {
    ...
    title: 'Sign Up',
    description:
      'Create your free Nepali Sathi passport in under a minute. No credit card required.',
  },
  {
    step: 2,
    title: 'Explore Sites',
    description:
      'Browse UNESCO heritage sites and hidden gems. Read curated guides, check visitor tips, and build your wishlist.',
  },
  {
    step: 3,
    title: 'Visit & Collect',
    description:
      'Arrive at any heritage site and collect a unique digital stamp in your passport. Each stamp unlocks stories and recommendations.',
  },
  {
    step: 4,
    title: 'Share & Inspire',
    description:
      'Share your collection with fellow travelers and discover new sites based on what others are exploring.',
  },
];

export const stats = [
  { value: '10', label: 'UNESCO Sites', suffix: '+' },
  { value: '50', label: 'Heritage Locations', suffix: '+' },
  { value: '25', label: 'Years of History', suffix: 'K+' },
  { value: '100', label: 'Curated Guides', suffix: '+' },
];
...
export const testimonials = [
  {
    ...
    avatar: '',
    quote:
      'Nepali Sathi turned my chaotic trip into a beautiful story. The digital passport made me feel like an explorer uncovering Kathmandu\'s secrets one stamp at a time.',
    rating: 5,
  },
  {
    name: 'James Mitchell',
    ...
    avatar: '',
    quote:
      'I\'ve traveled to over 30 countries, but nothing compares to walking through Bhaktapur with Nepali Sathi. The local insights were spot-on, and the stamps are addictive!',
    rating: 5,
  },
  {
    name: 'Aiko Tanaka',
    ...
    avatar: '',
    quote:
      'The cultural guides helped me understand the meaning behind each temple and ritual. I didn\'t just see Nepal — I felt it.',
    rating: 5,
  },
  {
    name: 'Rajesh Gurung',
    ...
    avatar: '',
    quote:
      'As a local, I thought I knew everything about my country. Nepali Sathi showed me heritage sites I had never explored. Proud to see Nepal told this well.',
    rating: 5,
  },
];